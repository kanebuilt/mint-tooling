  ...
  try {
    ...
    const newPackageJson = {
      ...
      scripts: {
        ...
        "asset:list": existingScripts["asset:list"] || "node scripts/asset.js list",
        "asset:add": existingScripts["asset:add"] || "node scripts/asset.js add",
        "asset:remove": existingScripts["asset:remove"] || "node scripts/asset.js remove",
